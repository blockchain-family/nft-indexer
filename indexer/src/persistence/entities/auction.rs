...
use crate::{
    models::events::{
        AuctionActive, AuctionCancelled, AuctionComplete, AuctionCreated, BidDeclined, BidPlaced, RoyaltySet,
    },
...
impl Decode for RoyaltySet {
    ...
    fn decode_event(&self, ctx: &DecodeContext) -> Result<Decoded> {
        ...
        Ok(Decoded::RawEventRecord(decoded::EventRecord { //Convert to real type
            event_category: EventCategory::Auction,
            event_type: EventType::AuctionCreated,
